...
// Helper to get extension resource URL
utils.getResourceUrl = function(path) {
...
utils.streamImageUrl = function(target) {
		if (target) {
				...
				if (data.image_url) {
						...
						if (data.icon == 'phone') {
								return utils.getResourceUrl('/assets/images/chip_phone.png')
						} else if (data.icon == 'tablet') {
								return utils.getResourceUrl('/assets/images/chip_tablet.png')
						} else if (data.icon == 'desktop') {
								return utils.getResourceUrl('/assets/images/chip_desktop.png')
						} else if (data.icon == 'laptop') {
								return utils.getResourceUrl('/assets/images/chip_laptop.png')
						} else if (data.icon == 'browser') {
								return utils.getResourceUrl('/assets/images/chip_browser.png')
						}
				} else if (data.kind) {
						...
						return utils.getResourceUrl('/assets/images/chip_channel.png')
				} else if (data.phone_type) {
						if (data.phone_type == 'mobile') {
								return utils.getResourceUrl('/assets/images/chip_phone.png')
						} else if (data.phone_type == 'home') {
								return utils.getResourceUrl('/assets/images/chip_home.png')
						} else if (data.phone_type == 'work') {
								return utils.getResourceUrl('/assets/images/chip_work.png')
						}
				} else if (data.email_normalized) {
						return utils.getResourceUrl('/assets/images/chip_person.png')
				}
		}

		return utils.getResourceUrl('/assets/images/chip_other.png')
}
